...
import { Phone, MessageCircle, HelpCircle, Send } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/resources" className="text-purple-200 hover:text-white">Resources</Link>
              </li>
              <li>
                <Link to="/community" className="text-purple-200 hover:text-white">Community</Link>
              </li>
              <li>
                <Link to="/emergency" className="text-purple-200 hover:text-white">Emergency Help</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-4">
              <h4 className="text-sm font-semibold mb-2">Subscribe to our updates</h4>
              <div className="flex">
                <input
                  type="email"
                  placeholder="Your email"
                  className="px-3 py-2 bg-purple-800 text-white rounded-l-md focus:outline-none"
                />
